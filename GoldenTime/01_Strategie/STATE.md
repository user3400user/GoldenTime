...
**Offen:** **record_delivery/reserve verdrahten (Exklusivität belegen)**; FAKTURIEREN; FLUSS-Zahlen nach 2. Snapshot; Mensch-QA-Durchlauf vor dem Essen (Links jetzt klickbar); Park: Konfidenz-Kalibrierung, LIKE-Escape, cohort-Single-Scan. Tech-Gedächtnis: `CLAUDE.md`.
