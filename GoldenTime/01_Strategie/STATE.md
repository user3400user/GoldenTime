...
**Offen:** FAKTURIEREN; FLUSS-Zahlen nach 2. Snapshot; Phase 3 Dashboard-Politur (nicht demo-kritisch, Vorschläge in CLAUDE.md); Park: Konfidenz-Kalibrierung. Tech-Gedächtnis: `CLAUDE.md`.
