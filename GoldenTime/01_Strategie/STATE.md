...
**Offen:** FAKTURIEREN; FLUSS-Zahlen nach 2. Snapshot; Phase 3 Dashboard-Politur (nicht demo-kritisch); Park: Konfidenz-Kalibrierung, Heuristik-Ausbau, Evidenz-Resolver-Härtung. Tech-Gedächtnis: `CLAUDE.md`.
